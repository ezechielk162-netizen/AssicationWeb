      ...
      <div class="container-fluid">
        ...
        >
          <ul :class="isOpen ? 'navbar-nav gap-2' : 'navbar-nav gap-4'">
            <li
              v-for="item in electionMenuItems"
              :key="item.name"
              class="nav-item"
            ...
            >
              ...
              <template v-if="!item.dropdown">
                <NuxtLink
                  ...
                  :class="
                    isOpen
                      ? 'nav-link dark-color gap-3 fs-5 gap-3'
                      : 'nav-link dark-color  gap-3'
                  "
                >
                  <component
            ...
            <li class="nav-item d-flex align-items-center gap-4">
              <a-button
                v-for="(btn, index) in electionActionButtons"
                :key="index"
                size="large"
                :class="[
                  btn.type === 'primary'
              ...
              >
                <component :is="btn.icon" class="fix-icon" />
                {{ btn.label }}
              </a-button>
            </li>
          </ul>
...
import { electionMenuItems, electionActionButtons } from "~/core/constant";
